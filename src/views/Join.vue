...
<template>
  <div class="w-full flex flex-col items-center justify-center overflow-hidden h-screen lg:px-0 px-3">
    <Dialog header=" " v-model:visible="displayDialog" contentClass="d-flex flex-column" dismissableMask modal>
      <p class="jfPlkw">
      Your application is under review. In the meantime, make sure to follow the project for updates.
      </p>
      <p style="margin-top: 15px;">The Blobs are coming…</p>
    </Dialog>
    <nav
      ...
      <div class=" flex items-center text-[#CACDD2] ">
        ...
        <a href="javascript:void(0)" @click="displayDialog = true" 
